    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('shipper.create') }}" class="btn btn-primary mb-3">
                    <i class="ti ti-plus fs-4"></i> Add Shipper
                </a>

                <div class="table-responsive">
                    <table id="shipperTable" class="table table-striped table-bordered text-nowrap align-middle w-100">
                        <thead>
                            <tr>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div class="position-relative">
                                        <span class="ti ti-search position-absolute top-50 start-0 translate-middle-y text-dark ms-3"></span>
                                        <input type="text" class="form-control ps-5 column-search" data-name="address" placeholder="Search Address">
                                    </div>
                                </th>
                                <th>
                                    <div class="position-relative">
                                        <span class="ti ti-search position-absolute top-50 start-0 translate-middle-y text-dark ms-3"></span>
                                        <input type="text" class="form-control ps-5 column-search" data-name="phone" placeholder="Search Phone">
                                    </div>
                                </th>
                                <th>
                                    <div class="position-relative">
                                ...
                                <th>
                                    <div class="position-relative">
                                        <span class="ti ti-search position-absolute top-50 start-0 translate-middle-y text-dark ms-3"></span>
                                        <input type="text" class="form-control ps-5 column-search" data-name="contact" placeholder="Search Contact">
                                    </div>
                                </th>
                                <th></th>
                            </tr>

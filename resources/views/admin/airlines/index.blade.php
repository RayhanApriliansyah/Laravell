...
<div class="body-wrapper">
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <a href="{{ route('airlines.create') }}" class="btn btn-primary mb-3">
                    <i class="ti ti-plus fs-4"></i>&nbsp; Add Airline
                </a>

                <div class="table-responsive">
                    <table id="airlinesTable" class="table table-striped table-bordered text-nowrap align-middle w-100">
                        <thead>
                            <tr>

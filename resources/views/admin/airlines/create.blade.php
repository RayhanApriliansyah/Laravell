                ...
                <form action="{{ route('airlines.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold    ">Airline Code</label>
                                <input type="text" name="code" class="form-control shadow-sm"
                                    placeholder="Enter airline code" required>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="file" name="logo" id="logo" class="form-control shadow-sm" accept="image/*"

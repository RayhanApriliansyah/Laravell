                    ...
                    <div class="col-xl-5 col-xxl-4">
                        <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
                            <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                                <h2 class="mb-1 fs-7 fw-bolder">Welcome to SBM Website</h2>
                                <p class="mb-7">Login With</p>
                                <div class="row">
                                    <div class="col-6 mb-2 mb-sm-0">
                                        <a class="btn text-dark border fw-normal d-flex align-items-center jus0tify-content-center rounded-2 py-8" href="javascript:void(0)" role="button">
                                ...
                                <form class="user" method="POST" action="{{ route('loginproses') }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control from-control-user"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password" class="form-control from-control-user "
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-medium">Dont Have Account?</p>

...
class AirlineController extends Controller
{
    ...
    {
        $query = Airline::with('country')->select('airlines.*');
        ...
        return DataTables::of($query)
            ...
            ->addColumn('actions', function ($row) {
                ...
                $delete = route('airlines.destroy', $row->id);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('airlines.index')->with('success', 'Airline added successfully!');
    }
